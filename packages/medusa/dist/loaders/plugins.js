...
function getResolvedPlugins(rootDirectory, configModule, extensionDirectoryPath) {
...
function registerPluginModels(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    resolved = getResolvedPlugins(rootDirectory, configModule, extensionDirectoryPath) ||
                        [];
...
function registerApi(pluginDetails, app, rootDirectory, container, configmodule, activityId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var logger, projectName, apiFolderExists, routes, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (err_2.code !== "MODULE_NOT_FOUND") {
                        ...
                        if (err_2.stack) {
                            logger.warn("".concat(err_2.stack));
                        }
                    }
                    return [2 /*return*/, app];
                case 4: return [2 /*return*/];
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        (0, plugins_1.registerPaymentServiceFromClass)(loaded, context);
                                        (0, plugins_1.registerPaymentProcessorFromClass)(loaded, context);
                                        (0, plugins_1.registerFulfillmentServiceFromClass)(loaded, context);
                                        (0, plugins_1.registerAbstractFulfillmentServiceFromClass)(loaded, context);
                                        if (!(loaded.prototype instanceof medusa_interfaces_1.OauthService)) return [3 /*break*/, 2];
                                    ...
                                    case 1:
                                        ...
                                        return [3 /*break*/, 3];
                                    case 2:
                                        if ((0, interfaces_1.isNotificationService)(loaded.prototype)) {
                                        ...
                                        else if (utils_1.SearchUtils.isSearchService(loaded.prototype)) {
                                            // Add the service directly to the container in order to make simple
    ...
    if (!(0, fs_exists_cached_1.sync)(pluginName)) {
        ...
        if ((0, fs_exists_cached_1.sync)(resolvedPath)) {
            if ((0, fs_exists_cached_1.sync)("".concat(resolvedPath, "/package.json"))) {
                ...
                var name_6 = packageJSON.name || pluginName;
                // warnOnIncompatiblePeerDependency(name, packageJSON)
                return {
                    resolve: resolvedPath,
                    name: name_6,
                    id: createPluginId(name_6),
                    options: {},
