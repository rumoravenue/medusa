...
var moduleResolutions = (0, modules_sdk_1.registerModules)({});
// Load non legacy modules
Object.keys(modules_config_1.default).map(function (moduleKey) {
    moduleResolutions[moduleKey] = (0, modules_sdk_1.registerMedusaModule)(moduleKey, modules_sdk_1.ModulesDefinition[moduleKey])[moduleKey];
});
var config = {
    projectConfig: {
            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if (opts.adminSession) {
                        token = jsonwebtoken_1.default.sign({ user_id: opts.adminSession.userId || ((_a = opts.adminSession.jwt) === null || _a === void 0 ? void 0 : _a.userId), domain: "admin" }, config.projectConfig.jwt_secret);
                        headers.Authorization = "Bearer ".concat(token);
                    }
                    if (opts.clientSession) {
                        token = jsonwebtoken_1.default.sign({ customer_id: opts.clientSession.customer_id || ((_b = opts.clientSession.jwt) === null || _b === void 0 ? void 0 : _b.customer_id), domain: "store" }, config.projectConfig.jwt_secret);
                        headers.Authorization = "Bearer ".concat(token);
                    }
