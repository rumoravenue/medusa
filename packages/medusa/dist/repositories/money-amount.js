...
exports.MoneyAmountRepository = database_1.dataSource
    ...
    updatePriceListPrices: function (priceListId, updates) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, existingPrices, newPrices, _b, newPriceEntities, joinTableValues, _c, prices, _d, _e, _f;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        _e = (_d = Promise).all;
                        _f = [this.save(__spreadArray(__spreadArray([], __read(existingPrices), false), __read(newPriceEntities), false))];
                        return [4 /*yield*/, this.manager.save(joinTableValues)];
                    case 1: return [4 /*yield*/, _e.apply(_d, [_f.concat([
                                _g.sent()
                            ])])];
                    case 2:
                        _c = __read.apply(void 0, [_g.sent(), 1]), prices = _c[0];
