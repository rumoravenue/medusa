...
var customers_1 = require("../../../../types/customers");
var class_transformer_1 = require("class-transformer");
var customers_2 = __importDefault(require("../../../../controllers/customers"));
/**
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, customers_2.default.listAndCount(req.scope, req.query, req.body)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [2 /*return*/];
...
}(customers_1.AdminListCustomerSelector));
