        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, priceListService.retrieve(priceList.id, {
                        select: index_1.defaultAdminPriceListFields,
                        relations: index_1.defaultAdminPriceListRelations,
                    })];
            case 2:
                priceList = _a.sent();
...
var AdminPostPriceListsPriceListReq = /** @class */ (function () {
    ...
    __decorate([
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsEnum)(price_list_1.PriceListStatus),
        __metadata("design:type", String)
    ], AdminPostPriceListsPriceListReq.prototype, "status", void 0);
    __decorate([
        (0, class_validator_1.IsEnum)(price_list_1.PriceListType),
        __metadata("design:type", String)
