    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                createInventoryItemWorkflow = (0, workflows_1.createInventoryItems)(req.scope);
                if (!featureFlagRouter.isFeatureEnabled(utils_1.ManyToManyInventoryFeatureFlag.key)) {
                    if (!variant_id) {
                        throw new utils_2.MedusaError(utils_2.MedusaError.Types.NOT_ALLOWED, "variant_id is required");
                    }
                    createInventoryItemWorkflow.appendAction("attachInventoryItems", workflows_1.CreateInventoryItemActions.createInventoryItems, {
                        invoke: (0, workflows_1.pipe)({
                            invoke: {
                                from: workflows_1.CreateInventoryItemActions.createInventoryItems,
                                alias: "createdItems",
                            },
                        }, generateAttachInventoryToVariantHandler(variant_id, productVariantInventoryService)),
                        compensate: (0, workflows_1.pipe)({
                            invoke: {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (inventoryItems.length) {
                            throw new utils_2.MedusaError(utils_2.MedusaError.Types.NOT_ALLOWED, "Inventory Item already exists for this variant");
                        }
