    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                if (!featureFlagRouter.isFeatureEnabled(isolate_pricing_domain_1.default.key)) return [3 /*break*/, 4];
                updateVariantsWorkflow = workflows_1.UpdateProductVariants.updateProductVariants(req.scope);
                input = {
                    productVariants: [
