...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, logger, productVariantRepo, productService, pricingService, productVariantService, productVariantInventoryService, inventoryService, manager, productModuleService, featureFlagRouter, isWorkflowEnabled, updateProductWorkflow, input, result, rawProduct, _a, product;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                isWorkflowEnabled = featureFlagRouter.isFeatureEnabled({
                    workflows: workflows_1.Workflows.UpdateProducts,
                });
                if (isWorkflowEnabled && !productModuleService) {
                    logger.warn("Cannot run ".concat(workflows_1.Workflows.UpdateProducts, " workflow without '@medusajs/product' installed"));
                }
                if (!(isWorkflowEnabled && !!productModuleService)) return [3 /*break*/, 3];
                updateProductWorkflow = (0, workflows_1.updateProducts)(req.scope);
                input = {
                    products: [
            ...
            case 4:
                ...
                _b.label = 5;
            case 5:
                if (!featureFlagRouter.isFeatureEnabled(isolate_product_domain_1.default.key)) return [3 /*break*/, 7];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    variables = { id: id };
                    query = {
                        product: __assign({ __args: variables }, _1.defaultAdminProductRemoteQueryObject),
                    };
