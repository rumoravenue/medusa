        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                isWorkflowEnabled = featureFlagRouter.isFeatureEnabled({
                    workflows: workflows_1.Workflows.CreateProducts,
                });
                if (isWorkflowEnabled && !productModuleService) {
                    logger.warn("Cannot run ".concat(workflows_1.Workflows.CreateProducts, " workflow without '@medusajs/product' installed"));
                }
                if (!(isWorkflowEnabled && !!productModuleService)) return [3 /*break*/, 3];
                createProductWorkflow = (0, workflows_1.createProducts)(req.scope);
                input = {
                    products: [
                        validated,
                    ],
            ...
            case 5:
                ...
                return [4 /*yield*/, getProductWithIsolatedProductModule(req, product.id)];
            case 6:
                rawProduct = _b.sent();
                return [3 /*break*/, 9];
