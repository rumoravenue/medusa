...
var workflows_1 = require("@medusajs/workflows");
var _1 = require(".");
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var entityManager, featureFlagRouter, cartService, productVariantInventoryService, validated, reqContext, isWorkflowEnabled, cart, cartWorkflow, input, _a, result, errors, lineItemService_1, regionService, regionId_1, regions, toCreate_1, customerService, customer;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                isWorkflowEnabled = featureFlagRouter.isFeatureEnabled({
                    workflows: workflows_1.Workflows.CreateCart,
                });
                if (!isWorkflowEnabled) return [3 /*break*/, 2];
                cartWorkflow = (0, workflows_1.createCart)(req.scope);
                input = __assign(__assign({}, validated), { publishableApiKeyScopes: req.publishableApiKeyScopes, context: __assign(__assign({}, reqContext), validated.context) });
                return [4 /*yield*/, cartWorkflow.run({
                        input: input,
                        context: {
            ...
            case 1:
                ...
                if (Array.isArray(errors)) {
                    if ((0, medusa_core_utils_1.isDefined)(errors[0])) {
                ...
                return [3 /*break*/, 9];
            case 2:
                lineItemService_1 = req.scope.resolve("lineItemService");
                regionService = req.scope.resolve("regionService");
                if (!(0, medusa_core_utils_1.isDefined)(validated.region_id)) return [3 /*break*/, 3];
                regionId_1 = validated.region_id;
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, regionService.list({})];
            case 4:
                regions = _c.sent();
            ...
            case 5:
                ...
                if (!(req.user && req.user.customer_id)) return [3 /*break*/, 7];
                customerService = req.scope.resolve("customerService");
                return [4 /*yield*/, customerService.retrieve(req.user.customer_id)];
            case 6:
                customer = _c.sent();
                toCreate_1["customer_id"] = customer.id;
                toCreate_1["email"] = customer.email;
                _c.label = 7;
            case 7:
                if (validated.country_code) {
                    toCreate_1["shipping_address"] = {
                        country_code: validated.country_code.toLowerCase(),
                    };
                }
                if (!toCreate_1.sales_channel_id &&
                    ((_b = req.publishableApiKeyScopes) === null || _b === void 0 ? void 0 : _b.sales_channel_ids.length)) {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    lineItemServiceTx = lineItemService_1.withTransaction(manager);
                                    return [4 /*yield*/, cartServiceTx.create(toCreate_1)];
                                case 1:
                                    createdCart = _c.sent();
            ...
            case 8:
                cart = _c.sent();
                _c.label = 9;
            case 9: return [4 /*yield*/, cartService.retrieveWithTotals(cart.id, {
