...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productService, productVariantInventoryService, pricingService, cartService, featureFlagRouter, validated, _a, cart_id, regionId, currencyCode, filterableFields, listConfig, isIsolateProductDomain, promises, _b, _c, rawProducts, count, cart, computedProducts, shouldSetPricing, shouldSetAvailability, decoratePromises;
    var _d, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                isIsolateProductDomain = featureFlagRouter.isFeatureEnabled(isolate_product_domain_1.default.key);
                promises = [];
            ...
            case 1:
                ...
                return [4 /*yield*/, Promise.all(decoratePromises)];
            case 2:
                // We can run them concurrently as the new properties are assigned to the references
                // of the appropriate entity
                _g.sent();
