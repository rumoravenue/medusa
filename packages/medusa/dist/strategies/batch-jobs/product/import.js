...
var ProductImportStrategy = /** @class */ (function (_super) {
    ...
    ProductImportStrategy.prototype.createProducts = function (batchJob) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var transactionManager, productOps, productServiceTx, productCollectionServiceTx, isSalesChannelsFeatureOn, isProductCategoriesFeatureOn, productOps_1, productOps_1_1, productOp, productData, _b, _c, _d, _e, _f, e_9, e_10_1;
            var e_10, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 12:
                        ...
                        return [3 /*break*/, 13];
                    case 13: return [4 /*yield*/, this.updateProgress(batchJob.id)];
                    case 14:
                        _h.sent();
                        _h.label = 15;
                    case 15:
    ...
    ProductImportStrategy.prototype.updateProducts = function (batchJob) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var transactionManager, productOps, productServiceTx, productCollectionServiceTx, isSalesChannelsFeatureOn, isProductCategoriesFeatureOn, productOps_2, productOps_2_1, productOp, productData, _b, _c, _d, _e, _f, e_11, e_12_1;
            var e_12, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        _h.label = 3;
                    case 3:
                        if (!!productOps_2_1.done) return [3 /*break*/, 16];
    ...
    ProductImportStrategy.prototype.createVariants = function (batchJob) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var transactionManager, variantOps, _loop_1, this_1, variantOps_1, variantOps_1_1, variantOp, e_13_1;
            var e_13, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _loop_1 = function (variantOp) {
                            var variant, product_1, optionIds_1, e_14;
    ...
    ProductImportStrategy.prototype.updateVariants = function (batchJob) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var transactionManager, variantOps, productServiceTx, variantOps_2, variantOps_2_1, variantOp, product, updateData, e_15, e_16_1;
            var e_16, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 6:
                        _c.sent();
                        updateData = (0, utils_1.transformVariantData)(variantOp);
