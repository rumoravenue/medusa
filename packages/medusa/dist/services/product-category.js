            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = (0, utils_1.buildQuery)(selector_, config);
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, pcRepo.countBy({
                                                parent_category_id: (0, utils_1.nullableValue)(productCategoryInput.parent_category_id),
                                            })];
                                    case 1:
    ...
    ProductCategoryService.prototype.update = function (productCategoryId, productCategoryInput) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var productCategory, productCategoryRepo, conditions, key;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, repository.countBy({
                                parent_category_id: (0, utils_1.nullableValue)(targetParentId),
