...
var ProductVariantInventoryService = /** @class */ (function (_super) {
    ...
    function ProductVariantInventoryService(_a) {
        var stockLocationService = _a.stockLocationService, salesChannelLocationService = _a.salesChannelLocationService, salesChannelInventoryService = _a.salesChannelInventoryService, productVariantService = _a.productVariantService, inventoryService = _a.inventoryService, eventBusService = _a.eventBusService;
        var _this = 
    ...
    ProductVariantInventoryService.prototype.attachInventoryItem = function (variantIdOrAttachments, inventoryItemId, requiredQuantity) {
        return __awaiter(this, void 0, void 0, function () {
            var data, invalidDataEntries, variants, foundVariantIds, requestedVariantIds, difference, _a, inventoryItems, foundInventoryItemIds, requestedInventoryItemIds, difference, variantInventoryRepo, existingAttachments, existingMap, toCreate;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(variants.map(function (variant) { return __awaiter(_this, void 0, void 0, function () {
                                var variantInventory, locations;
                                var _a;
                                return __generator(this, function (_b) {
                                    if (!variant.id) {
                                    ...
                                    variantInventory = variantInventoryMap.get(variant.id) || [];
                                    ...
                                    locations = (_a = inventoryLocationMap.get(variantInventory[0].inventory_item_id)) !== null && _a !== void 0 ? _a : [];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _c = [Math];
                        _d = [[]];
                        return [4 /*yield*/, Promise.all(variantInventoryItems.map(function (variantInventory) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
