...
declare class PricingService extends TransactionBaseService {
    ...
    constructor({ productVariantService, taxProviderService, regionService, priceSelectionStrategy, featureFlagRouter, remoteQuery, pricingModuleService, }: InjectedDependencies);
    /**
