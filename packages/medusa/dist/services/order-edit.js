...
var OrderEditService = /** @class */ (function (_super) {
    ...
    OrderEditService.prototype.decorateTotals = function (orderEdit) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, order_id, items, orderServiceTx, order, computedOrder, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _a = _e.sent(), order_id = _a.order_id, items = _a.items;
    ...
    OrderEditService.prototype.confirm = function (orderEditId, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var orderEditRepository, orderEdit, lineItemServiceTx, _a, lineItems, itemsIds;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        orderEditRepository = manager.withRepository(this.orderEditRepository_);
                                    ...
                                    case 2:
                                        _a = __read.apply(void 0, [_b.sent(), 1]), lineItems = _a[0];
                                    ...
                                    case 3:
                                        ...
                                        itemsIds = lineItems.map(function (i) { return i.id; });
