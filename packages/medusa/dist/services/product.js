            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = this.activeManager_;
                        productRepo = manager.withRepository(this.productRepository_);
                        _a = (0, utils_2.buildQuery)(selector, config), relations = _a.relations, query = __rest(_a, ["relations"]);
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    ...
                                    case 9:
                                        _e.variants = _g.sent();
                                        _g.label = 10;
                                    case 10: return [4 /*yield*/, this.retrieve(product.id, {
                                            relations: ["options"],
                                        })];
                                    case 11:
                                        result = _g.sent();
