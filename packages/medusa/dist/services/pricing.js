...
var PricingService = /** @class */ (function (_super) {
    ...
    function PricingService(_a) {
        var productVariantService = _a.productVariantService, taxProviderService = _a.taxProviderService, regionService = _a.regionService, priceSelectionStrategy = _a.priceSelectionStrategy, featureFlagRouter = _a.featureFlagRouter, remoteQuery = _a.remoteQuery, pricingModuleService = _a.pricingModuleService;
        var _this = 
        ...
        _this.pricingModuleService = pricingModuleService;
        _this.remoteQuery = remoteQuery;
        return _this;
    }
    /**
    ...
    PricingService.prototype.getProductVariantPricingModulePricing_ = function (variantPriceData, context) {
        return __awaiter(this, void 0, void 0, function () {
            var variables, query, variantPriceSets, variantIdToPriceSetIdMap, priceSetIds, queryContext, priceSets, priceSetMap, pricingResultMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        variables = {
                    ...
                    case 1:
                        ...
                        priceSets = [];
                        if (!queryContext.currency_code) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        priceSetMap = new Map(priceSets.map(function (priceSet) { return [priceSet.id, priceSet]; }));
                        ...
                        variantPriceData.forEach(function (_a) {
                            ...
                            if (priceSetId) {
                                var prices = priceSetMap.get(priceSetId);
                                if (prices) {
                                    pricingResult.prices = [prices];
    ...
    PricingService.prototype.getProductVariantPricing_ = function (data, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!(this.featureFlagRouter.isFeatureEnabled(isolate_product_domain_1.default.key) &&
                            this.featureFlagRouter.isFeatureEnabled(isolate_pricing_domain_1.default.key))) return [3 /*break*/, 2];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        variantIdMoneyAmountMap = priceSetMoneyAmounts.reduce(function (map, priceSetMoneyAmount) {
                            ...
                            var moneyAmount = __assign(__assign({}, priceSetMoneyAmount.money_amount), { region_id: null });
                            if (regionId) {
    ...
    PricingService.prototype.setAdminVariantPricing = function (variants, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.featureFlagRouter.isFeatureEnabled(isolate_pricing_domain_1.default.key)) return [3 /*break*/, 2];
