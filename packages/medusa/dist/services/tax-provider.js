            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(__spreadArray([], __read(cacheKeysMap), false).map(function (_a) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(nonCachedProductIds.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                                var rates, toReturn;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
