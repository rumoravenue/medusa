                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 16:
                                        ...
                                        return [7 /*endfinally*/];
                                    case 17:
                                        if (!((_e = payCol.payment_sessions) === null || _e === void 0 ? void 0 : _e.length)) return [3 /*break*/, 19];
                                        removeSessions = payCol.payment_sessions.filter(function (_a) {
                                            var id = _a.id;
                                            return !selectedSessionIds.includes(id);
                                        });
                                        if (!removeSessions.length) return [3 /*break*/, 19];
                                    ...
                                    case 18:
                                        ...
                                        Promise.all(removeSessions.map(function (sess) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
