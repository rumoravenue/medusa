...
var isolate_product_domain_1 = __importDefault(require("../loaders/feature-flags/isolate-product-domain"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.featureFlagRouter_.isFeatureEnabled(isolate_product_domain_1.default.key)) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.storeService_.withTransaction(this.activeManager_).retrieve({
    ...
    CartService.prototype.update = function (cartOrId, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cartRepo, relations, cart, _a, originalCartCustomer, customer, shippingAddress_1, countryCode, addrRepo, billingAddress, shippingAddress, previousDiscounts, hasFreeShipping, prevContext, updatedCart;
                            var _this = this;
                            var _b, _c, _d, _e, _f;
                                ...
                                switch (_g.label) {
                                    ...
                                    case 15:
                                        if (!(this.featureFlagRouter_.isFeatureEnabled(sales_channels_1.default.key) &&
                                            ...
                                            data.sales_channel_id != cart.sales_channel_id)) return [3 /*break*/, 17];
                                    ...
                                    case 16:
                                        ...
                                        _g.label = 17;
                                    case 17:
                                        if (!((0, utils_1.isDefined)(data.discounts) && data.discounts.length)) return [3 /*break*/, 23];
                                    ...
                                    case 18:
                                        ...
                                        if (!(previousDiscounts.some(function (_a) {
                                            ...
                                            !hasFreeShipping)) return [3 /*break*/, 20];
                                        return [4 /*yield*/, this.adjustFreeShipping_(cart, false)];
                                    case 19:
                                        _g.sent();
                                        _g.label = 20;
                                    case 20:
                                        if (!hasFreeShipping) return [3 /*break*/, 22];
                                    ...
                                    case 23:
                                        if (!((0, utils_1.isDefined)(data.discounts) && !data.discounts.length)) return [3 /*break*/, 25];
                                        cart.discounts.length = 0;
                                        return [4 /*yield*/, this.refreshAdjustments_(cart)];
                                    case 24:
                                        _g.sent();
                                        _g.label = 25;
                                    case 25:
                                        if (!("gift_cards" in data)) return [3 /*break*/, 27];
                                        cart.gift_cards = [];
                                        return [4 /*yield*/, Promise.all(((_f = data.gift_cards) !== null && _f !== void 0 ? _f : []).map(function (_a) {
                                                var code = _a.code;
                                    ...
                                    case 28:
                                        ...
                                        if (!((data.email && data.email !== originalCartCustomer.email) ||
                                            (data.customer_id && data.customer_id !== originalCartCustomer.id))) return [3 /*break*/, 30];
                                        return [4 /*yield*/, this.eventBus_
                                                .withTransaction(transactionManager)
    ...
    CartService.prototype.addShippingMethod = function (cartOrId, optionId, data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cart, _a, cartCustomShippingOptions, customShippingOption, shipping_methods, shippingMethodConfig, newShippingMethod, methods, shippingOptionServiceTx, shipping_methods_1, shipping_methods_1_1, shippingMethod, e_3_1, lineItemServiceTx_1, productShippinProfileMap_1, updatedCart;
                            var e_3, _b;
                            var _this = this;
                            var _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 14:
                                        ...
                                        productShippinProfileMap_1 = new Map();
                                        if (!this.featureFlagRouter_.isFeatureEnabled(isolate_product_domain_1.default.key)) return [3 /*break*/, 16];
                                    ...
                                    case 15:
                                        productShippinProfileMap_1 =
                                            _d.sent();
                                        return [3 /*break*/, 17];
                                    case 16:
                                        productShippinProfileMap_1 = new Map(cart.items.map(function (item) {
                                            var _a, _b, _c, _d;
                                            return [
                                        ...
                                        _d.label = 17;
                                    case 17: return [4 /*yield*/, Promise.all(cart.items.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                                            var _a;
                                            return __generator(this, function (_b) {
                                                return [2 /*return*/, lineItemServiceTx_1.update(item.id, {
                                                        has_shipping: this.validateLineItemShipping_(methods, productShippinProfileMap_1.get((_a = item.variant) === null || _a === void 0 ? void 0 : _a.product_id)),
                                                    })];
                                            });
                                        }); }))];
                                    case 18:
