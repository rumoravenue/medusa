...
import { ICacheService, IEventBusService, IInventoryService, InventoryItemDTO, InventoryLevelDTO, IStockLocationService, ReservationItemDTO, ReserveQuantityContext } from "@medusajs/types";
...
declare class ProductVariantInventoryService extends TransactionBaseService {
    ...
    constructor({ stockLocationService, salesChannelLocationService, salesChannelInventoryService, productVariantService, inventoryService, eventBusService, }: InjectedDependencies);
    /**
