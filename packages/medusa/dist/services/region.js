            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _a = region;
                        return [4 /*yield*/, Promise.all(regionData.countries.map(function (countryCode) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    ...
                    case 4:
                        ...
                        _b = region;
                        return [4 /*yield*/, Promise.all(regionData.payment_providers.map(function (pId) { return __awaiter(_this, void 0, void 0, function () {
                                var pp;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                    ...
                    case 6:
                        ...
                        _c = region;
                        return [4 /*yield*/, Promise.all(regionData.fulfillment_providers.map(function (fId) { return __awaiter(_this, void 0, void 0, function () {
                                var fp;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
