...
var EventBusService = /** @class */ (function (_super) {
    ...
    function EventBusService(_a, config, isSingleton) {
        var stagedJobService = _a.stagedJobService, eventBusModuleService = _a.eventBusModuleService, logger = _a.logger;
        ...
        _this.eventBusModuleService_ = eventBusModuleService;
    ...
    EventBusService.prototype.emit = function (eventNameOrData, data, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, isBulkEmit, events, stagedJobs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        events = isBulkEmit
                            ? eventNameOrData.map(function (event) { return ({
