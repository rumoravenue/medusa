...
var runLinkMigrations = function (directory) { return __awaiter(void 0, void 0, void 0, function () {
    var configModule, container, runMigrations, options;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                configModule = (0, config_1.default)(directory);
...
var main = function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var args, configModule, dataSource, featureFlagRouter, unapplied;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    dataSource = _b.sent();
                    featureFlagRouter = (0, feature_flags_1.default)(configModule);
                    if (!(args[0] === "run")) return [3 /*break*/, 7];
                ...
                case 4:
                    ...
                    if (!(featureFlagRouter.isFeatureEnabled(isolate_product_domain_1.default.key) ||
                        featureFlagRouter.isFeatureEnabled(isolate_pricing_domain_1.default.key))) return [3 /*break*/, 6];
                ...
                case 6:
                    ...
                    return [3 /*break*/, 14];
                case 7:
                    if (!(args[0] === "revert")) return [3 /*break*/, 11];
                ...
                case 10:
                    ...
                    return [3 /*break*/, 14];
                case 11:
                    if (!(args[0] === "show")) return [3 /*break*/, 14];
