        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    errors_1 = new Map();
                    return [4 /*yield*/, Promise.all(plain.map(function (p) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    errors = new Map();
                                    return [4 /*yield*/, Promise.all(types.map(function (v) { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
