...
function queryEntityWithoutRelations(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var alias, qb, shouldJoins, customJoinBuilders_2, customJoinBuilders_2_1, customJoinBuilder, result, e_3_1, entities, count, result;
        var e_3, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 8:
                    ...
                    return [4 /*yield*/, Promise.all([qb.getMany(), qb.getCount()])];
                case 9:
                    result = _f.sent();
                    entities = result[0];
                    count = result[1];
                    return [3 /*break*/, 12];
                case 10: return [4 /*yield*/, qb.getMany()];
                case 11:
                    entities = _f.sent();
                    _f.label = 12;
